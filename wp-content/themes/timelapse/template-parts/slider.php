...
<a href="#">
    <article id="slide1">
        <img src="<?= _URL_IMAGES; ?>/_visuels_dyns/slide-1.jpg" alt="HEART BEAT MANUFACTURE SLIDE" />
        ...
        <div class="puces-slider">
            <a href="#slide1"><span class="active"></span></a>
...
<a href="#">
     <article id="slide2">
        ...
        <div class="slide-content">
            ...
            On adore son bracelet en cuir d'alligator et son cadran en verre saphir bombé. Un must-have à ne pas manquer !
            </p>
            <a href="#" class="link">
                <i class="fa fa-long-arrow-right" aria-hidden="true"></i>DÉCOUVRIR LE MODÈLE
            </a>
        ...
        <div class="puces-slider">
            ...
            <a href="#slide2"><span class="active"></span></a>
            <a href="#slide3"><span></span></a>
        </div>
    </article>
</a>
...
<a href="#">
     <article id="slide3">
        ...
        <div class="puces-slider">
            <a href="#slide1"><span></span></a>
            <a href="#slide2"><span></span></a>
            <a href="#slide3"><span class="active"></span></a>
        </div>
    </article>
</a>
